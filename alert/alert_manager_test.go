...
func TestManager_ValidateConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			manager := NewManager(&tt.config, "TestApp")
...
func TestManager_SendAlert_NoMethods(t *testing.T) {
...
func TestManager_BuildEmailBody(t *testing.T) {
	config := &types.AlertingConfig{}
...
func TestManager_SendAlerts(t *testing.T) {
	config := &types.AlertingConfig{} // No alerting methods configured
